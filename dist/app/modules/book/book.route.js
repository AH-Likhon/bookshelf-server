...
router.get('/:id', (0, auth_1.default)(), book_controller_1.BookController.getSingleBookFromDB);
...
router.get('/', (0, auth_1.default)(), book_controller_1.BookController.getAllBooksFromDB);
